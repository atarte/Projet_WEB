...
function content_605b446007c462_34493847 (Smarty_Internal_Template $_smarty_tpl) {
ob_start();
    ...
    <div class="row justify-content-between">
        <article class="col">
            ...
            <fieldset class="field">
                <legend id="legend_form">Liste de candidature</legend>
